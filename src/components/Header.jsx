        ...
        <div className="container mx-auto py-2">
          <div className="flex item-center justify-between">
            <div className="flex items-center">
              <img src="https://upload.wikimedia.org/wikipedia/commons/e/e8/Tesla_logo.png" alt="" className="inline-block mr-2 w-10" />
              <h1 className="text-2xl font-bold">Nigga Store</h1>
            </div>
